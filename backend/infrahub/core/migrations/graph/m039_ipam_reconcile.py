...
class Migration039(ArbitraryMigration):
    ...
    async def execute(self, db: InfrahubDatabase) -> MigrationResult:
        ...
        console.log("Identifying IP prefixes and addresses to reconcile...")
        find_nodes_query = await FindNodesToReconcileQuery.init(db=db)
        await find_nodes_query.execute(db=db)
        console.log("Identified IP prefixes and addresses requiring reconciliation.")
        ...
        console.log("Deleting self-parent relationships prior to reconciliation...")
        ...
        console.log("Removed self-parent relationships where applicable.")
